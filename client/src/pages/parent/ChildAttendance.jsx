...
const ChildAttendance = () => {
  ...
  const filteredAttendance = (report?.attendance || []).filter((item) => {
    ...
    const matchesStatus = statusFilter === "all" || item.studentStatus === statusFilter;

    const matchesSubject = subjectFilter === "all" || item.subjectId?._id === subjectFilter;
  ...
  return (
    <section className="space-y-6 pb-28">
      <PageHeader
        ...
        description="Track your child's subject-wise attendance register and period count."
      />
              ...
              <div className="flex-1">
                ...
                <div className="mt-4">
                  <div className="flex items-end gap-2">
                    ...
                    <span className="mb-2 text-sm font-medium" style={{ color: attendanceBand.toneColor }}>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm" style={{ color: attendanceBand.toneColor }}>
                    {attendanceBand.key === "warning"
                      ? `Your child's attendance is below ${attendanceBand.goodThreshold}%. Please ensure regular class attendance.`
                      : `Your child's attendance is below ${attendanceBand.warningThreshold}%. Please ensure regular class attendance immediately.`}
                  </p>
                </div>
              </div>
            </div>
                ...
                {matrixData.rows.length === 0 ? (
                  <div className="flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <p className="text-xs text-slate-400 dark:text-slate-500 mt-1">
                      Attendance register will appear here once teachers mark attendance.
                    </p>
                  </div>
                ) : (() => {
                  ...
                  <div className="flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <p className="text-xs text-slate-400 dark:text-slate-500 mt-1">
                      {report.attendance?.length === 0
                        ? "Attendance will appear here once teachers start marking attendance."
