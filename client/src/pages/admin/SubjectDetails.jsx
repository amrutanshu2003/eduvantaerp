  ...
  return (
    <section className="space-y-6">
      <PageHeader
        ...
        description="Review subject details and assigned teacher."
        actions={
          <div className="flex gap-3">
            <Link to={`/admin/subjects/${id}/edit`} className="rounded-full border border-slate-200 px-4 py-3 text-sm font-semibold text-slate-700">
              Edit
            </Link>
            <Link to={`/admin/subjects/${id}/assign-teacher`} className="rounded-full border border-slate-200 px-4 py-3 text-sm font-semibold text-slate-700">
              Assign Teacher
            </Link>
            <button
              type="button"
