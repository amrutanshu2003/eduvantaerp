...
const Staff = () => {
  ...
  return (
    <section className="space-y-6">
      <PageHeader eyebrow="Admin" title="Staff" description="Manage institute staff accounts and permissions." actions={<Link to="/admin/staff/create" style={{ backgroundColor: settings.primaryColor, borderRadius: getButtonRadius(settings.buttonStyle) }} className="px-5 py-3 text-sm font-semibold text-white">Create Staff</Link>} />
