...
const Timetable = () => {
  ...
  useEffect(() => {
    const load = async () => {
      try {
        const { data } = await api.get("/timetables/teacher/my-timetable");
