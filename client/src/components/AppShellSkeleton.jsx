import { SkeletonAvatar, SkeletonBlock, SkeletonButton, SkeletonCard, SkeletonLines, SkeletonTable } from "./Skeleton";
                    ...
                    {Array.from({ length: 4 }).map((_, index) => (
                      <div key={index} className="flex items-center gap-4 rounded-2xl border border-slate-100 px-4 py-4">
                        ...
                        <div className="flex-1">
                          <SkeletonBlock className="h-3.5 w-5/12 rounded-md" />
                          <SkeletonBlock className="mt-3 h-3.5 w-9/12 rounded-md" />
                        </div>
